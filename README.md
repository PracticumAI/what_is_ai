...
1. Summarize the unique instructional features of the Practicum AI training program.
...
4. Outline the basic steps in the AI project lifecycle.
5. Develop an AI project plan. 

 
#### To Do List
- Create an AI project plan for something of interest to you. 
...
By the end of this module, students will be able to:
1. Compose a short definition of artificial intelligence that accurately reflects present capabilities. 
